...
<textarea id="show-images">
	<br/>
	&nbsp;标题:&nbsp;<input type="text" name="img_title[]" value="<?php echo $orig_name; ?>" style="width:330px" maxlength="50" />
	<input class="del-cmd" type="button" onclick="def_img(this)" value="删除" />&nbsp;
	
	<a id="<?php echo $file_name; ?>" class="img-cmd" href="<?php echo $arr_res['temp'], $file_name; ?>" target="_blank">
	看大图<br/><img src="<?php echo $arr_res['temp'], $file_name_thumb; ?>" /></a>&nbsp;
