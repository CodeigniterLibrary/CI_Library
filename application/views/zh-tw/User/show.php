...
<div id="container">
	...
	<form name="mainform" method="" action="<?php echo $script_name; ?>/User">
		...
		<table id="script-input">
			...
			<tr>
				<td width="120"><span class="blue">手機</span></td>
				...
				<?php foreach ($res as $k => $v): ?>
					...
					<tr>
						...
						<td>
							...
							<a class="button" href="<?php echo $script_name; ?>/user/detail?<?php echo $query_string; ?>&chkopt[0]=<?php echo $v['user_id']; ?>" target="_blank">詳細</a>
						</td>
					</tr>
