<div id="container">
	...
	<form name="mainform" method="post" action="">
		...
		<table class="detail-view" id="yw0">
			...
			<?php endif; ?>
			<tr class="even"><th>名稱</th><td><?php echo $res['user_name']; ?>&nbsp;</td></tr>
			<tr class="even"><th>email</th><td><?php echo $res['user_email']; ?>&nbsp;</td></tr>
			<tr class="even"><th>手機</th><td><?php echo $res['user_phone']; ?>&nbsp;</td></tr>
			<tr class="even"><th>關注</th><td><?php echo say_name(ele('user_attention', $res), $arr_res['arr_attention']); ?>&nbsp;</td></tr>
			<?php if ($cmd === 'detail'): ?>
