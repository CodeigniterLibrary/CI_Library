...
class CI_Profiler {
	...
	protected function _compile_benchmarks()
	{
		...
		{
			$output .= "<tr><td style='padding:5px;width:50%;color:#000;font-weight:bold;background-color:#ddd;'>".ucwords(strtr($key, '_-', '  '))."&nbsp;&nbsp;</td><td style='padding:5px;width:50%;color:#900;font-weight:normal;background-color:#ddd;'>{$val}</td></tr>\n";
		}
